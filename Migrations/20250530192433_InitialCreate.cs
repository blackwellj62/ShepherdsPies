        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderTakeEpId = table.Column<int>(type: "integer", nullable: false),
                    DeliverEpId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_Employees_DeliverEpId",
                        column: x => x.DeliverEpId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Employees_OrderTakeEpId",
                        column: x => x.OrderTakeEpId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "40ebf81d-d761-4924-936e-b757245314da", "admina@strator.comx", false, false, null, null, null, "AQAAAAIAAYagAAAAEO2Ett7By5sdIr4UwMqepi3nUMV+8spBscY6iLQVrmE9NGK69NI+3ZNe1/HxIjBUFA==", null, false, "cb797976-eae1-4eb0-91fa-da46c081e5e6", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "DeliverEpId", "IsDelivery", "OrderDateTime", "OrderTakeEpId", "TableNumber", "Tip" },
                values: new object[,]
                {
                    { 1, 3, true, new DateTime(2025, 5, 30, 14, 30, 0, 0, DateTimeKind.Unspecified), 1, null, 10.00m },
                    { 2, null, false, new DateTime(2025, 5, 30, 18, 20, 0, 0, DateTimeKind.Unspecified), 2, 1, 20.00m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DeliverEpId",
                table: "Orders",
                column: "DeliverEpId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderTakeEpId",
                table: "Orders",
                column: "OrderTakeEpId");
